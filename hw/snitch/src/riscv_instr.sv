...
package riscv_instr;
  ...
  localparam logic [31:0] MXDOTP_B1          = 32'b?????????????????001?????1110111;
  localparam logic [31:0] MXDOTP_B2          = 32'b?????????????????010?????1110111;
  localparam logic [31:0] MXDOTP_B3          = 32'b?????????????????011?????1110111;
  ...
  localparam logic [31:0] P_LB_IRPOST        = 32'b?????????????????000?????0001011;
  localparam logic [31:0] P_LBU_IRPOST       = 32'b?????????????????100?????0001011;
  localparam logic [31:0] P_LH_IRPOST        = 32'b?????????????????001?????0001011;
  localparam logic [31:0] P_LHU_IRPOST       = 32'b?????????????????101?????0001011;
  localparam logic [31:0] P_LW_IRPOST        = 32'b?????????????????010?????0001011;
  localparam logic [31:0] P_LB_RRPOST        = 32'b0000000??????????111?????0001011;
  localparam logic [31:0] P_LBU_RRPOST       = 32'b0100000??????????111?????0001011;
  localparam logic [31:0] P_LH_RRPOST        = 32'b0001000??????????111?????0001011;
  localparam logic [31:0] P_LHU_RRPOST       = 32'b0101000??????????111?????0001011;
  localparam logic [31:0] P_LW_RRPOST        = 32'b0010000??????????111?????0001011;
  localparam logic [31:0] P_LB_RR            = 32'b0000000??????????111?????0000011;
  localparam logic [31:0] P_LBU_RR           = 32'b0100000??????????111?????0000011;
  localparam logic [31:0] P_LH_RR            = 32'b0001000??????????111?????0000011;
  localparam logic [31:0] P_LHU_RR           = 32'b0101000??????????111?????0000011;
  localparam logic [31:0] P_LW_RR            = 32'b0010000??????????111?????0000011;
  localparam logic [31:0] P_SB_IRPOST        = 32'b?????????????????000?????0101011;
  localparam logic [31:0] P_SH_IRPOST        = 32'b?????????????????001?????0101011;
  localparam logic [31:0] P_SW_IRPOST        = 32'b?????????????????010?????0101011;
  localparam logic [31:0] P_SB_RRPOST        = 32'b0000000??????????100?????0101011;
  localparam logic [31:0] P_SH_RRPOST        = 32'b0000000??????????101?????0101011;
  localparam logic [31:0] P_SW_RRPOST        = 32'b0000000??????????110?????0101011;
  localparam logic [31:0] P_SB_RR            = 32'b0000000??????????100?????0100011;
  localparam logic [31:0] P_SH_RR            = 32'b0000000??????????101?????0100011;
  localparam logic [31:0] P_SW_RR            = 32'b0000000??????????110?????0100011;
  localparam logic [31:0] P_ABS              = 32'b000001000000?????000?????0110011;
  localparam logic [31:0] P_EXTHS            = 32'b000100000000?????100?????0110011;
  localparam logic [31:0] P_EXTHZ            = 32'b000100000000?????101?????0110011;
  localparam logic [31:0] P_EXTBS            = 32'b000100000000?????110?????0110011;
  localparam logic [31:0] P_EXTBZ            = 32'b000100000000?????111?????0110011;
  localparam logic [31:0] P_EXTRACT          = 32'b11???????????????000?????0110011;
  localparam logic [31:0] P_EXTRACTR         = 32'b1000000??????????000?????0110011;
  localparam logic [31:0] P_EXTRACTU         = 32'b11???????????????001?????0110011;
  localparam logic [31:0] P_EXTRACTUR        = 32'b1000000??????????001?????0110011;
  localparam logic [31:0] P_INSERT           = 32'b11???????????????010?????0110011;
  localparam logic [31:0] P_INSERTR          = 32'b1000000??????????010?????0110011;
  localparam logic [31:0] P_BSET             = 32'b11???????????????100?????0110011;
  localparam logic [31:0] P_BSETR            = 32'b1000000??????????100?????0110011;
  localparam logic [31:0] P_BCLR             = 32'b11???????????????011?????0110011;
  localparam logic [31:0] P_BCLRR            = 32'b1000000??????????011?????0110011;
  localparam logic [31:0] P_CNT              = 32'b0001000??????????011?????0110011;
  localparam logic [31:0] P_CLB              = 32'b000100000000?????010?????0110011;
  localparam logic [31:0] P_FL1              = 32'b000100000000?????001?????0110011;
  localparam logic [31:0] P_FF1              = 32'b000100000000?????000?????0110011;
  localparam logic [31:0] P_ROR              = 32'b000010000000?????101?????0110011;
  localparam logic [31:0] P_BEQIMM           = 32'b?????????????????010?????1100011;
  localparam logic [31:0] P_BNEIMM           = 32'b?????????????????011?????1100011;
  localparam logic [31:0] P_CLIP             = 32'b0001010??????????001?????0110011;
  localparam logic [31:0] P_CLIPR            = 32'b0001010??????????101?????0110011;
  localparam logic [31:0] P_CLIPU            = 32'b0001010??????????010?????0110011;
  localparam logic [31:0] P_CLIPUR           = 32'b0001010??????????110?????0110011;
  localparam logic [31:0] P_MAC              = 32'b0100001??????????000?????0110011;
  localparam logic [31:0] P_MSU              = 32'b0100001??????????001?????0110011;
  localparam logic [31:0] P_MIN              = 32'b0000010??????????100?????0110011;
  localparam logic [31:0] P_MINU             = 32'b0000010??????????101?????0110011;
  localparam logic [31:0] P_MAX              = 32'b0000010??????????110?????0110011;
  localparam logic [31:0] P_MAXU             = 32'b0000010??????????111?????0110011;
  localparam logic [31:0] P_ADDN             = 32'b00???????????????010?????1011011;
  localparam logic [31:0] P_ADDUN            = 32'b10???????????????010?????1011011;
  localparam logic [31:0] P_SLET             = 32'b0000010??????????010?????0110011;
  localparam logic [31:0] P_SLETU            = 32'b0000010??????????011?????0110011;
  localparam logic [31:0] PV_ADD_H           = 32'b0000000??????????000?????1010111;
  localparam logic [31:0] PV_ADD_SC_H        = 32'b0000000??????????100?????1010111;
  localparam logic [31:0] PV_ADD_SCI_H       = 32'b000000???????????110?????1010111;
  localparam logic [31:0] PV_ADD_B           = 32'b0000000??????????001?????1010111;
  localparam logic [31:0] PV_ADD_SC_B        = 32'b0000000??????????101?????1010111;
  localparam logic [31:0] PV_ADD_SCI_B       = 32'b000000???????????111?????1010111;
  localparam logic [31:0] PV_SUB_H           = 32'b0000100??????????000?????1010111;
  localparam logic [31:0] PV_SUB_SC_H        = 32'b0000100??????????100?????1010111;
  localparam logic [31:0] PV_SUB_SCI_H       = 32'b000010???????????110?????1010111;
  localparam logic [31:0] PV_SUB_B           = 32'b0000100??????????001?????1010111;
  localparam logic [31:0] PV_SUB_SC_B        = 32'b0000100??????????101?????1010111;
  localparam logic [31:0] PV_SUB_SCI_B       = 32'b000010???????????111?????1010111;
  localparam logic [31:0] PV_AVG_H           = 32'b0001000??????????000?????1010111;
  localparam logic [31:0] PV_AVG_SC_H        = 32'b0001000??????????100?????1010111;
  localparam logic [31:0] PV_AVG_SCI_H       = 32'b000100???????????110?????1010111;
  localparam logic [31:0] PV_AVG_B           = 32'b0001000??????????001?????1010111;
  localparam logic [31:0] PV_AVG_SC_B        = 32'b0001000??????????101?????1010111;
  localparam logic [31:0] PV_AVG_SCI_B       = 32'b000100???????????111?????1010111;
  localparam logic [31:0] PV_AVGU_H          = 32'b0001100??????????000?????1010111;
  localparam logic [31:0] PV_AVGU_SC_H       = 32'b0001100??????????100?????1010111;
  localparam logic [31:0] PV_AVGU_SCI_H      = 32'b000110???????????110?????1010111;
  localparam logic [31:0] PV_AVGU_B          = 32'b0001100??????????001?????1010111;
  localparam logic [31:0] PV_AVGU_SC_B       = 32'b0001100??????????101?????1010111;
  localparam logic [31:0] PV_AVGU_SCI_B      = 32'b000110???????????111?????1010111;
  localparam logic [31:0] PV_MIN_H           = 32'b0010000??????????000?????1010111;
  localparam logic [31:0] PV_MIN_SC_H        = 32'b0010000??????????100?????1010111;
  localparam logic [31:0] PV_MIN_SCI_H       = 32'b001000???????????110?????1010111;
  localparam logic [31:0] PV_MIN_B           = 32'b0010000??????????001?????1010111;
  localparam logic [31:0] PV_MIN_SC_B        = 32'b0010000??????????101?????1010111;
  localparam logic [31:0] PV_MIN_SCI_B       = 32'b001000???????????111?????1010111;
  localparam logic [31:0] PV_MINU_H          = 32'b0010100??????????000?????1010111;
  localparam logic [31:0] PV_MINU_SC_H       = 32'b0010100??????????100?????1010111;
  localparam logic [31:0] PV_MINU_SCI_H      = 32'b001010???????????110?????1010111;
  localparam logic [31:0] PV_MINU_B          = 32'b0010100??????????001?????1010111;
  localparam logic [31:0] PV_MINU_SC_B       = 32'b0010100??????????101?????1010111;
  localparam logic [31:0] PV_MINU_SCI_B      = 32'b001010???????????111?????1010111;
  localparam logic [31:0] PV_MAX_H           = 32'b0011000??????????000?????1010111;
  localparam logic [31:0] PV_MAX_SC_H        = 32'b0011000??????????100?????1010111;
  localparam logic [31:0] PV_MAX_SCI_H       = 32'b001100???????????110?????1010111;
  localparam logic [31:0] PV_MAX_B           = 32'b0011000??????????001?????1010111;
  localparam logic [31:0] PV_MAX_SC_B        = 32'b0011000??????????101?????1010111;
  localparam logic [31:0] PV_MAX_SCI_B       = 32'b001100???????????111?????1010111;
  localparam logic [31:0] PV_MAXU_H          = 32'b0011100??????????000?????1010111;
  localparam logic [31:0] PV_MAXU_SC_H       = 32'b0011100??????????100?????1010111;
  localparam logic [31:0] PV_MAXU_SCI_H      = 32'b001110???????????110?????1010111;
  localparam logic [31:0] PV_MAXU_B          = 32'b0011100??????????001?????1010111;
  localparam logic [31:0] PV_MAXU_SC_B       = 32'b0011100??????????101?????1010111;
  localparam logic [31:0] PV_MAXU_SCI_B      = 32'b001110???????????111?????1010111;
  localparam logic [31:0] PV_SRL_H           = 32'b0100000??????????000?????1010111;
  localparam logic [31:0] PV_SRL_SC_H        = 32'b0100000??????????100?????1010111;
  localparam logic [31:0] PV_SRL_SCI_H       = 32'b010000???????????110?????1010111;
  localparam logic [31:0] PV_SRL_B           = 32'b0100000??????????001?????1010111;
  localparam logic [31:0] PV_SRL_SC_B        = 32'b0100000??????????101?????1010111;
  localparam logic [31:0] PV_SRL_SCI_B       = 32'b010000???????????111?????1010111;
  localparam logic [31:0] PV_SRA_H           = 32'b0100100??????????000?????1010111;
  localparam logic [31:0] PV_SRA_SC_H        = 32'b0100100??????????100?????1010111;
  localparam logic [31:0] PV_SRA_SCI_H       = 32'b010010???????????110?????1010111;
  localparam logic [31:0] PV_SRA_B           = 32'b0100100??????????001?????1010111;
  localparam logic [31:0] PV_SRA_SC_B        = 32'b0100100??????????101?????1010111;
  localparam logic [31:0] PV_SRA_SCI_B       = 32'b010010???????????111?????1010111;
  localparam logic [31:0] PV_SLL_H           = 32'b0101000??????????000?????1010111;
  localparam logic [31:0] PV_SLL_SC_H        = 32'b0101000??????????100?????1010111;
  localparam logic [31:0] PV_SLL_SCI_H       = 32'b010100???????????110?????1010111;
  localparam logic [31:0] PV_SLL_B           = 32'b0101000??????????001?????1010111;
  localparam logic [31:0] PV_SLL_SC_B        = 32'b0101000??????????101?????1010111;
  localparam logic [31:0] PV_SLL_SCI_B       = 32'b010100???????????111?????1010111;
  localparam logic [31:0] PV_OR_H            = 32'b0101100??????????000?????1010111;
  localparam logic [31:0] PV_OR_SC_H         = 32'b0101100??????????100?????1010111;
  localparam logic [31:0] PV_OR_SCI_H        = 32'b010110???????????110?????1010111;
  localparam logic [31:0] PV_OR_B            = 32'b0101100??????????001?????1010111;
  localparam logic [31:0] PV_OR_SC_B         = 32'b0101100??????????101?????1010111;
  localparam logic [31:0] PV_OR_SCI_B        = 32'b010110???????????111?????1010111;
  localparam logic [31:0] PV_XOR_H           = 32'b0110000??????????000?????1010111;
  localparam logic [31:0] PV_XOR_SC_H        = 32'b0110000??????????100?????1010111;
  localparam logic [31:0] PV_XOR_SCI_H       = 32'b011000???????????110?????1010111;
  localparam logic [31:0] PV_XOR_B           = 32'b0110000??????????001?????1010111;
  localparam logic [31:0] PV_XOR_SC_B        = 32'b0110000??????????101?????1010111;
  localparam logic [31:0] PV_XOR_SCI_B       = 32'b011000???????????111?????1010111;
  localparam logic [31:0] PV_AND_H           = 32'b0110100??????????000?????1010111;
  localparam logic [31:0] PV_AND_SC_H        = 32'b0110100??????????100?????1010111;
  localparam logic [31:0] PV_AND_SCI_H       = 32'b011010???????????110?????1010111;
  localparam logic [31:0] PV_AND_B           = 32'b0110100??????????001?????1010111;
  localparam logic [31:0] PV_AND_SC_B        = 32'b0110100??????????101?????1010111;
  localparam logic [31:0] PV_AND_SCI_B       = 32'b011010???????????111?????1010111;
  localparam logic [31:0] PV_ABS_H           = 32'b011100000000?????000?????1010111;
  localparam logic [31:0] PV_ABS_B           = 32'b011100000000?????001?????1010111;
  localparam logic [31:0] PV_EXTRACT_H       = 32'b011110???????????110?????1010111;
  localparam logic [31:0] PV_EXTRACT_B       = 32'b011110???????????111?????1010111;
  localparam logic [31:0] PV_EXTRACTU_H      = 32'b100100???????????110?????1010111;
  localparam logic [31:0] PV_EXTRACTU_B      = 32'b100100???????????111?????1010111;
  localparam logic [31:0] PV_INSERT_H        = 32'b101100???????????110?????1010111;
  localparam logic [31:0] PV_INSERT_B        = 32'b101100???????????111?????1010111;
  localparam logic [31:0] PV_DOTSP_H         = 32'b1001100??????????000?????1010111;
  localparam logic [31:0] PV_DOTSP_SC_H      = 32'b1001100??????????100?????1010111;
  localparam logic [31:0] PV_DOTSP_SCI_H     = 32'b100110???????????110?????1010111;
  localparam logic [31:0] PV_DOTSP_B         = 32'b1001100??????????001?????1010111;
  localparam logic [31:0] PV_DOTSP_SC_B      = 32'b1001100??????????101?????1010111;
  localparam logic [31:0] PV_DOTSP_SCI_B     = 32'b100110???????????111?????1010111;
  localparam logic [31:0] PV_DOTUP_H         = 32'b1000000??????????000?????1010111;
  localparam logic [31:0] PV_DOTUP_SC_H      = 32'b1000000??????????100?????1010111;
  localparam logic [31:0] PV_DOTUP_SCI_H     = 32'b100000???????????110?????1010111;
  localparam logic [31:0] PV_DOTUP_B         = 32'b1000000??????????001?????1010111;
  localparam logic [31:0] PV_DOTUP_SC_B      = 32'b1000000??????????101?????1010111;
  localparam logic [31:0] PV_DOTUP_SCI_B     = 32'b100000???????????111?????1010111;
  localparam logic [31:0] PV_DOTUSP_H        = 32'b1000100??????????000?????1010111;
  localparam logic [31:0] PV_DOTUSP_SC_H     = 32'b1000100??????????100?????1010111;
  localparam logic [31:0] PV_DOTUSP_SCI_H    = 32'b100010???????????110?????1010111;
  localparam logic [31:0] PV_DOTUSP_B        = 32'b1000100??????????001?????1010111;
  localparam logic [31:0] PV_DOTUSP_SC_B     = 32'b1000100??????????101?????1010111;
  localparam logic [31:0] PV_DOTUSP_SCI_B    = 32'b100010???????????111?????1010111;
  localparam logic [31:0] PV_SDOTSP_H        = 32'b1011100??????????000?????1010111;
  localparam logic [31:0] PV_SDOTSP_SC_H     = 32'b1011100??????????100?????1010111;
  localparam logic [31:0] PV_SDOTSP_SCI_H    = 32'b101110???????????110?????1010111;
  localparam logic [31:0] PV_SDOTSP_B        = 32'b1011100??????????001?????1010111;
  localparam logic [31:0] PV_SDOTSP_SC_B     = 32'b1011100??????????101?????1010111;
  localparam logic [31:0] PV_SDOTSP_SCI_B    = 32'b101110???????????111?????1010111;
  localparam logic [31:0] PV_SDOTUP_H        = 32'b1010000??????????000?????1010111;
  localparam logic [31:0] PV_SDOTUP_SC_H     = 32'b1010000??????????100?????1010111;
  localparam logic [31:0] PV_SDOTUP_SCI_H    = 32'b101000???????????110?????1010111;
  localparam logic [31:0] PV_SDOTUP_B        = 32'b1010000??????????001?????1010111;
  localparam logic [31:0] PV_SDOTUP_SC_B     = 32'b1010000??????????101?????1010111;
  localparam logic [31:0] PV_SDOTUP_SCI_B    = 32'b101000???????????111?????1010111;
  localparam logic [31:0] PV_SDOTUSP_H       = 32'b1010100??????????000?????1010111;
  localparam logic [31:0] PV_SDOTUSP_SC_H    = 32'b1010100??????????100?????1010111;
  localparam logic [31:0] PV_SDOTUSP_SCI_H   = 32'b101010???????????110?????1010111;
  localparam logic [31:0] PV_SDOTUSP_B       = 32'b1010100??????????001?????1010111;
  localparam logic [31:0] PV_SDOTUSP_SC_B    = 32'b1010100??????????101?????1010111;
  localparam logic [31:0] PV_SDOTUSP_SCI_B   = 32'b101010???????????111?????1010111;
  localparam logic [31:0] PV_CMPEQ_H         = 32'b0000010??????????000?????1010111;
  localparam logic [31:0] PV_CMPEQ_SC_H      = 32'b0000010??????????100?????1010111;
  localparam logic [31:0] PV_CMPEQ_SCI_H     = 32'b000001???????????110?????1010111;
  localparam logic [31:0] PV_CMPEQ_B         = 32'b0000010??????????001?????1010111;
  localparam logic [31:0] PV_CMPEQ_SC_B      = 32'b0000010??????????101?????1010111;
  localparam logic [31:0] PV_CMPEQ_SCI_B     = 32'b000001???????????111?????1010111;
  localparam logic [31:0] PV_CMPNE_H         = 32'b0000110??????????000?????1010111;
  localparam logic [31:0] PV_CMPNE_SC_H      = 32'b0000110??????????100?????1010111;
  localparam logic [31:0] PV_CMPNE_SCI_H     = 32'b000011???????????110?????1010111;
  localparam logic [31:0] PV_CMPNE_B         = 32'b0000110??????????001?????1010111;
  localparam logic [31:0] PV_CMPNE_SC_B      = 32'b0000110??????????101?????1010111;
  localparam logic [31:0] PV_CMPNE_SCI_B     = 32'b000011???????????111?????1010111;
  localparam logic [31:0] PV_CMPGT_H         = 32'b0001010??????????000?????1010111;
  localparam logic [31:0] PV_CMPGT_SC_H      = 32'b0001010??????????100?????1010111;
  localparam logic [31:0] PV_CMPGT_SCI_H     = 32'b000101???????????110?????1010111;
  localparam logic [31:0] PV_CMPGT_B         = 32'b0001010??????????001?????1010111;
  localparam logic [31:0] PV_CMPGT_SC_B      = 32'b0001010??????????101?????1010111;
  localparam logic [31:0] PV_CMPGT_SCI_B     = 32'b000101???????????111?????1010111;
  localparam logic [31:0] PV_CMPGE_H         = 32'b0001110??????????000?????1010111;
  localparam logic [31:0] PV_CMPGE_SC_H      = 32'b0001110??????????100?????1010111;
  localparam logic [31:0] PV_CMPGE_SCI_H     = 32'b000111???????????110?????1010111;
  localparam logic [31:0] PV_CMPGE_B         = 32'b0001110??????????001?????1010111;
  localparam logic [31:0] PV_CMPGE_SC_B      = 32'b0001110??????????101?????1010111;
  localparam logic [31:0] PV_CMPGE_SCI_B     = 32'b000111???????????111?????1010111;
  localparam logic [31:0] PV_CMPLT_H         = 32'b0010010??????????000?????1010111;
  localparam logic [31:0] PV_CMPLT_SC_H      = 32'b0010010??????????100?????1010111;
  localparam logic [31:0] PV_CMPLT_SCI_H     = 32'b001001???????????110?????1010111;
  localparam logic [31:0] PV_CMPLT_B         = 32'b0010010??????????001?????1010111;
  localparam logic [31:0] PV_CMPLT_SC_B      = 32'b0010010??????????101?????1010111;
  localparam logic [31:0] PV_CMPLT_SCI_B     = 32'b001001???????????111?????1010111;
  localparam logic [31:0] PV_CMPLE_H         = 32'b0010110??????????000?????1010111;
  localparam logic [31:0] PV_CMPLE_SC_H      = 32'b0010110??????????100?????1010111;
  localparam logic [31:0] PV_CMPLE_SCI_H     = 32'b001011???????????110?????1010111;
  localparam logic [31:0] PV_CMPLE_B         = 32'b0010110??????????001?????1010111;
  localparam logic [31:0] PV_CMPLE_SC_B      = 32'b0010110??????????101?????1010111;
  localparam logic [31:0] PV_CMPLE_SCI_B     = 32'b001011???????????111?????1010111;
  localparam logic [31:0] PV_CMPGTU_H        = 32'b0011010??????????000?????1010111;
  localparam logic [31:0] PV_CMPGTU_SC_H     = 32'b0011010??????????100?????1010111;
  localparam logic [31:0] PV_CMPGTU_SCI_H    = 32'b001101???????????110?????1010111;
  localparam logic [31:0] PV_CMPGTU_B        = 32'b0011010??????????001?????1010111;
  localparam logic [31:0] PV_CMPGTU_SC_B     = 32'b0011010??????????101?????1010111;
  localparam logic [31:0] PV_CMPGTU_SCI_B    = 32'b001101???????????111?????1010111;
  localparam logic [31:0] PV_CMPGEU_H        = 32'b0011110??????????000?????1010111;
  localparam logic [31:0] PV_CMPGEU_SC_H     = 32'b0011110??????????100?????1010111;
  localparam logic [31:0] PV_CMPGEU_SCI_H    = 32'b001111???????????110?????1010111;
  localparam logic [31:0] PV_CMPGEU_B        = 32'b0011110??????????001?????1010111;
  localparam logic [31:0] PV_CMPGEU_SC_B     = 32'b0011110??????????101?????1010111;
  localparam logic [31:0] PV_CMPGEU_SCI_B    = 32'b001111???????????111?????1010111;
  localparam logic [31:0] PV_CMPLTU_H        = 32'b0100010??????????000?????1010111;
  localparam logic [31:0] PV_CMPLTU_SC_H     = 32'b0100010??????????100?????1010111;
  localparam logic [31:0] PV_CMPLTU_SCI_H    = 32'b010001???????????110?????1010111;
  localparam logic [31:0] PV_CMPLTU_B        = 32'b0100010??????????001?????1010111;
  localparam logic [31:0] PV_CMPLTU_SC_B     = 32'b0100010??????????101?????1010111;
  localparam logic [31:0] PV_CMPLTU_SCI_B    = 32'b010001???????????111?????1010111;
  localparam logic [31:0] PV_CMPLEU_H        = 32'b0100110??????????000?????1010111;
  localparam logic [31:0] PV_CMPLEU_SC_H     = 32'b0100110??????????100?????1010111;
  localparam logic [31:0] PV_CMPLEU_SCI_H    = 32'b010011???????????110?????1010111;
  localparam logic [31:0] PV_CMPLEU_B        = 32'b0100110??????????001?????1010111;
  localparam logic [31:0] PV_CMPLEU_SC_B     = 32'b0100110??????????101?????1010111;
  localparam logic [31:0] PV_CMPLEU_SCI_B    = 32'b010011???????????111?????1010111;
  localparam logic [31:0] PV_ADD_H_DIV2      = 32'b0111010??????????010?????1010111;
  localparam logic [31:0] PV_ADD_H_DIV4      = 32'b0111010??????????100?????1010111;
  localparam logic [31:0] PV_ADD_H_DIV8      = 32'b0111010??????????110?????1010111;
  localparam logic [31:0] PV_SUB_H_DIV2      = 32'b0110010??????????010?????1010111;
  localparam logic [31:0] PV_SUB_H_DIV4      = 32'b0110010??????????100?????1010111;
  localparam logic [31:0] PV_SUB_H_DIV8      = 32'b0110010??????????110?????1010111;
  localparam logic [31:0] PV_SHUFFLE_H       = 32'b1100000??????????000?????1010111;
  localparam logic [31:0] PV_SHUFFLE_SCI_H   = 32'b110000???????????110?????1010111;
  localparam logic [31:0] PV_SHUFFLE_B       = 32'b1100000??????????001?????1010111;
  localparam logic [31:0] PV_SHUFFLEI0_SCI_B = 32'b110000???????????111?????1010111;
  ...
  localparam logic [31:0] PV_SHUFFLEI3_SCI_B = 32'b111110???????????111?????1010111;
  localparam logic [31:0] PV_SHUFFLE2_H      = 32'b1100100??????????000?????1010111;
  localparam logic [31:0] PV_SHUFFLE2_B      = 32'b1100100??????????001?????1010111;
  localparam logic [31:0] PV_PACK            = 32'b1101000??????????000?????1010111;
