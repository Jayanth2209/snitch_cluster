...
package snitch_riscv_instr;
  ...
  localparam [31:0] BDEP               = 32'b0100100??????????110?????0110011;
  localparam [31:0] BEQ                = 32'b?????????????????000?????1100011;
  localparam [31:0] BFP                = 32'b0100100??????????111?????0110011;
  ...
  localparam [31:0] CV_LB_IRPOST       = 32'b?????????????????000?????0001011;
  localparam [31:0] CV_LB_RR           = 32'b0000100??????????011?????0101011;
  localparam [31:0] CV_LB_RRPOST       = 32'b0000000??????????011?????0101011;
  localparam [31:0] CV_LBU_IRPOST      = 32'b?????????????????100?????0001011;
  localparam [31:0] CV_LBU_RR          = 32'b0001100??????????011?????0101011;
  localparam [31:0] CV_LBU_RRPOST      = 32'b0001000??????????011?????0101011;
  localparam [31:0] CV_LH_IRPOST       = 32'b?????????????????001?????0001011;
  localparam [31:0] CV_LH_RR           = 32'b0000101??????????011?????0101011;
  localparam [31:0] CV_LH_RRPOST       = 32'b0000001??????????011?????0101011;
  localparam [31:0] CV_LHU_IRPOST      = 32'b?????????????????101?????0001011;
  localparam [31:0] CV_LHU_RR          = 32'b0001101??????????011?????0101011;
  localparam [31:0] CV_LHU_RRPOST      = 32'b0001001??????????011?????0101011;
  localparam [31:0] CV_LW_IRPOST       = 32'b?????????????????010?????0001011;
  localparam [31:0] CV_LW_RR           = 32'b0000110??????????011?????0101011;
  localparam [31:0] CV_LW_RRPOST       = 32'b0000010??????????011?????0101011;
  localparam [31:0] CV_SB_IRPOST       = 32'b?????????????????000?????0101011;
  localparam [31:0] CV_SB_RR           = 32'b0010100??????????011?????0101011;
  localparam [31:0] CV_SB_RRPOST       = 32'b0010000??????????011?????0101011;
  localparam [31:0] CV_SH_IRPOST       = 32'b?????????????????001?????0101011;
  localparam [31:0] CV_SH_RR           = 32'b0010101??????????011?????0101011;
  localparam [31:0] CV_SH_RRPOST       = 32'b0010001??????????011?????0101011;
  localparam [31:0] CV_SW_IRPOST       = 32'b?????????????????010?????0101011;
  localparam [31:0] CV_SW_RR           = 32'b0010110??????????011?????0101011;
  localparam [31:0] CV_SW_RRPOST       = 32'b0010010??????????011?????0101011;
  localparam [31:0] DIV                = 32'b0000001??????????100?????0110011;
  localparam [31:0] DIVU               = 32'b0000001??????????101?????0110011;
  localparam [31:0] DIVUW              = 32'b0000001??????????101?????0111011;
  localparam [31:0] DIVW               = 32'b0000001??????????100?????0111011;
  localparam [31:0] DMCPY              = 32'b0000011??????????000?????0101011;
  localparam [31:0] DMCPYI             = 32'b0000010??????????000?????0101011;
  localparam [31:0] DMDST              = 32'b0000001??????????000000000101011;
  localparam [31:0] DMINIT             = 32'b0001001??????????000?????0101011;
  localparam [31:0] DMREP              = 32'b000011100000?????000000000101011;
  localparam [31:0] DMSRC              = 32'b0000000??????????000000000101011;
  localparam [31:0] DMSTAT             = 32'b0000101?????00000000?????0101011;
  localparam [31:0] DMSTATI            = 32'b0000100?????00000000?????0101011;
  localparam [31:0] DMSTR              = 32'b0000110??????????000000000101011;
  localparam [31:0] DMUSER             = 32'b0001000??????????000000000101011;
  ...
  localparam [31:0] FCVT_B_B           = 32'b010001100011?????000?????1010011;
  ...
  localparam [31:0] FCVT_D_W_COPIFT    = 32'b110100100000?????????????0101011;
  localparam [31:0] FCVT_D_WU          = 32'b110100100001?????????????1010011;
  localparam [31:0] FCVT_D_WU_COPIFT   = 32'b110100100001?????????????0101011;
  localparam [31:0] FCVT_H_B           = 32'b010001000011?????000?????1010011;
  localparam [31:0] FCVT_H_D           = 32'b010001000001?????????????1010011;
  localparam [31:0] FCVT_H_H           = 32'b010001000010?????????????1010011;
  ...
  localparam [31:0] FLB                = 32'b?????????????????100?????0000111;
  ...
  localparam [31:0] FLT_D_COPIFT       = 32'b1010001??????????001?????0101011;
  ...
  localparam [31:0] FREP_O             = 32'b????????????????????????10001011;
  localparam [31:0] FSB                = 32'b?????????????????100?????0100111;
  ...
  localparam [31:0] GORC               = 32'b0010100??????????101?????0110011;
  localparam [31:0] GORCI              = 32'b001010???????????101?????0010011;
  localparam [31:0] GREV               = 32'b0110100??????????101?????0110011;
  localparam [31:0] GREVI              = 32'b011010???????????101?????0010011;
  ...
  localparam [31:0] IADD               = 32'b0000000??????????000?????1011011;
  localparam [31:0] IADDI              = 32'b?????????????????000?????1111011;
  localparam [31:0] IAND               = 32'b0000000??????????111?????1011011;
  localparam [31:0] IANDI              = 32'b?????????????????111?????1111011;
  localparam [31:0] IANDN              = 32'b0100000??????????111?????1011011;
  localparam [31:0] IBDEP              = 32'b0100100??????????110?????1011011;
  localparam [31:0] IBEXT              = 32'b0000100??????????110?????1011011;
  localparam [31:0] IBFP               = 32'b0100100??????????111?????1011011;
  localparam [31:0] ICLMUL             = 32'b0000101??????????001?????1011011;
  localparam [31:0] ICLMULH            = 32'b0000101??????????011?????1011011;
  localparam [31:0] ICLMULR            = 32'b0000101??????????010?????1011011;
  localparam [31:0] ICLZ               = 32'b011000000000?????010?????1011011;
  localparam [31:0] ICRC32_B           = 32'b011000010000?????001?????1011011;
  localparam [31:0] ICRC32_H           = 32'b011000010001?????001?????1011011;
  localparam [31:0] ICRC32_W           = 32'b011000010010?????001?????1011011;
  localparam [31:0] ICRC32C_B          = 32'b011000011000?????001?????1011011;
  localparam [31:0] ICRC32C_H          = 32'b011000011001?????001?????1011011;
  localparam [31:0] ICRC32C_W          = 32'b011000011010?????001?????1011011;
  localparam [31:0] ICTZ               = 32'b011000000001?????010?????1011011;
  localparam [31:0] IGORC              = 32'b0010100??????????101?????1011011;
  localparam [31:0] IGORCI             = 32'b001010???????????101?????1111011;
  localparam [31:0] IGREV              = 32'b0110100??????????101?????1011011;
  localparam [31:0] IGREVI             = 32'b011010???????????101?????1111011;
  localparam [31:0] IMADD              = 32'b?????01??????????000?????1011011;
  localparam [31:0] IMAX               = 32'b0000101??????????101?????1011011;
  localparam [31:0] IMAXU              = 32'b0000101??????????111?????1011011;
  localparam [31:0] IMIN               = 32'b0000101??????????100?????1011011;
  localparam [31:0] IMINU              = 32'b0000101??????????110?????1011011;
  localparam [31:0] IMSUB              = 32'b?????01??????????001?????1011011;
  localparam [31:0] IMUL               = 32'b0000010??????????000?????1011011;
  localparam [31:0] IMULH              = 32'b0000010??????????001?????1011011;
  localparam [31:0] IMULHSU            = 32'b0000010??????????010?????1011011;
  localparam [31:0] IMULHU             = 32'b0000010??????????011?????1011011;
  localparam [31:0] IMV_W_X            = 32'b111100000000?????000?????1011011;
  localparam [31:0] IMV_X_W            = 32'b111000000000?????000?????1011011;
  localparam [31:0] INMADD             = 32'b?????01??????????011?????1011011;
  localparam [31:0] INMSUB             = 32'b?????01??????????010?????1011011;
  localparam [31:0] IOR                = 32'b0000000??????????110?????1011011;
  localparam [31:0] IORI               = 32'b?????????????????110?????1111011;
  localparam [31:0] IORN               = 32'b0100000??????????110?????1011011;
  localparam [31:0] IPACK              = 32'b0000100??????????100?????1011011;
  localparam [31:0] IPACKH             = 32'b0000100??????????111?????1011011;
  localparam [31:0] IPACKU             = 32'b0100100??????????100?????1011011;
  localparam [31:0] IPCNT              = 32'b011000000010?????010?????1011011;
  localparam [31:0] IREP               = 32'b?????????????????????????0111111;
  localparam [31:0] IROL               = 32'b0110000??????????001?????1011011;
  localparam [31:0] IROR               = 32'b0110000??????????101?????1011011;
  localparam [31:0] IRORI              = 32'b011000???????????101?????1111011;
  localparam [31:0] ISBCLR             = 32'b0100100??????????001?????1011011;
  localparam [31:0] ISBCLRI            = 32'b010010???????????001?????1111011;
  localparam [31:0] ISBEXT             = 32'b0100100??????????101?????1011011;
  localparam [31:0] ISBEXTI            = 32'b010010???????????101?????1111011;
  localparam [31:0] ISBINV             = 32'b0110100??????????001?????1011011;
  localparam [31:0] ISBINVI            = 32'b011010???????????001?????1111011;
  localparam [31:0] ISBSET             = 32'b0010100??????????001?????1011011;
  localparam [31:0] ISBSETI            = 32'b001010???????????001?????1111011;
  localparam [31:0] ISEXT_B            = 32'b011000000100?????010?????1011011;
  localparam [31:0] ISEXT_H            = 32'b011000000101?????010?????1011011;
  localparam [31:0] ISH1ADD            = 32'b0010000??????????010?????1011011;
  localparam [31:0] ISH2ADD            = 32'b0010000??????????100?????1011011;
  localparam [31:0] ISH3ADD            = 32'b0010000??????????110?????1011011;
  localparam [31:0] ISHFL              = 32'b0000100??????????001?????1011011;
  localparam [31:0] ISHFLI             = 32'b0000100??????????001?????1111011;
  localparam [31:0] ISLL               = 32'b0000000??????????001?????1011011;
  localparam [31:0] ISLLI              = 32'b000000???????????001?????1111011;
  localparam [31:0] ISLO               = 32'b0010000??????????001?????1011011;
  localparam [31:0] ISLOI              = 32'b001000???????????001?????1111011;
  localparam [31:0] ISLT               = 32'b0000000??????????010?????1011011;
  localparam [31:0] ISLTI              = 32'b?????????????????010?????1111011;
  localparam [31:0] ISLTIU             = 32'b?????????????????011?????1111011;
  localparam [31:0] ISLTU              = 32'b0000000??????????011?????1011011;
  localparam [31:0] ISRA               = 32'b0100000??????????101?????1011011;
  localparam [31:0] ISRAI              = 32'b010000???????????101?????1111011;
  localparam [31:0] ISRL               = 32'b0000000??????????101?????1011011;
  localparam [31:0] ISRLI              = 32'b000000???????????101?????1111011;
  localparam [31:0] ISRO               = 32'b0010000??????????101?????1011011;
  localparam [31:0] ISROI              = 32'b001000???????????101?????1111011;
  localparam [31:0] ISUB               = 32'b0100000??????????000?????1011011;
  localparam [31:0] IUNSHFL            = 32'b0000100??????????101?????1011011;
  localparam [31:0] IUNSHFLI           = 32'b0000100??????????101?????1111011;
  localparam [31:0] IXNOR              = 32'b0100000??????????100?????1011011;
  localparam [31:0] IXOR               = 32'b0000000??????????100?????1011011;
  localparam [31:0] IXORI              = 32'b?????????????????100?????1111011;
  ...
  localparam [31:0] P_ADDN             = 32'b00???????????????010?????1011011;
  localparam [31:0] P_ADDUN            = 32'b10???????????????010?????1011011;
  localparam [31:0] P_BCLR             = 32'b11???????????????011?????0110011;
  localparam [31:0] P_BCLRR            = 32'b1000000??????????011?????0110011;
  localparam [31:0] P_BEQIMM           = 32'b?????????????????010?????1100011;
  localparam [31:0] P_BNEIMM           = 32'b?????????????????011?????1100011;
  localparam [31:0] P_BSET             = 32'b11???????????????100?????0110011;
  localparam [31:0] P_BSETR            = 32'b1000000??????????100?????0110011;
  localparam [31:0] P_CLB              = 32'b000100000000?????010?????0110011;
  ...
  localparam [31:0] P_CNT              = 32'b0001000??????????011?????0110011;
  ...
  localparam [31:0] P_EXTRACT          = 32'b11???????????????000?????0110011;
  localparam [31:0] P_EXTRACTR         = 32'b1000000??????????000?????0110011;
  localparam [31:0] P_EXTRACTU         = 32'b11???????????????001?????0110011;
  localparam [31:0] P_EXTRACTUR        = 32'b1000000??????????001?????0110011;
  localparam [31:0] P_FF1              = 32'b000100000000?????000?????0110011;
  localparam [31:0] P_FL1              = 32'b000100000000?????001?????0110011;
  localparam [31:0] P_INSERT           = 32'b11???????????????010?????0110011;
  localparam [31:0] P_INSERTR          = 32'b1000000??????????010?????0110011;
  ...
  localparam [31:0] P_ROR              = 32'b000010000000?????101?????0110011;
  ...
  localparam [31:0] PACKU              = 32'b0100100??????????100?????0110011;
  ...
  localparam [31:0] PV_ADD_H_DIV2      = 32'b0111010??????????010?????1010111;
  localparam [31:0] PV_ADD_H_DIV4      = 32'b0111010??????????100?????1010111;
  localparam [31:0] PV_ADD_H_DIV8      = 32'b0111010??????????110?????1010111;
  ...
  localparam [31:0] PV_CMPEQ_B         = 32'b0000010??????????001?????1010111;
  localparam [31:0] PV_CMPEQ_H         = 32'b0000010??????????000?????1010111;
  localparam [31:0] PV_CMPEQ_SC_B      = 32'b0000010??????????101?????1010111;
  localparam [31:0] PV_CMPEQ_SC_H      = 32'b0000010??????????100?????1010111;
  localparam [31:0] PV_CMPEQ_SCI_B     = 32'b000001???????????111?????1010111;
  localparam [31:0] PV_CMPEQ_SCI_H     = 32'b000001???????????110?????1010111;
  localparam [31:0] PV_CMPGE_B         = 32'b0001110??????????001?????1010111;
  localparam [31:0] PV_CMPGE_H         = 32'b0001110??????????000?????1010111;
  localparam [31:0] PV_CMPGE_SC_B      = 32'b0001110??????????101?????1010111;
  localparam [31:0] PV_CMPGE_SC_H      = 32'b0001110??????????100?????1010111;
  localparam [31:0] PV_CMPGE_SCI_B     = 32'b000111???????????111?????1010111;
  localparam [31:0] PV_CMPGE_SCI_H     = 32'b000111???????????110?????1010111;
  localparam [31:0] PV_CMPGEU_B        = 32'b0011110??????????001?????1010111;
  localparam [31:0] PV_CMPGEU_H        = 32'b0011110??????????000?????1010111;
  localparam [31:0] PV_CMPGEU_SC_B     = 32'b0011110??????????101?????1010111;
  localparam [31:0] PV_CMPGEU_SC_H     = 32'b0011110??????????100?????1010111;
  localparam [31:0] PV_CMPGEU_SCI_B    = 32'b001111???????????111?????1010111;
  localparam [31:0] PV_CMPGEU_SCI_H    = 32'b001111???????????110?????1010111;
  localparam [31:0] PV_CMPGT_B         = 32'b0001010??????????001?????1010111;
  localparam [31:0] PV_CMPGT_H         = 32'b0001010??????????000?????1010111;
  localparam [31:0] PV_CMPGT_SC_B      = 32'b0001010??????????101?????1010111;
  localparam [31:0] PV_CMPGT_SC_H      = 32'b0001010??????????100?????1010111;
  localparam [31:0] PV_CMPGT_SCI_B     = 32'b000101???????????111?????1010111;
  localparam [31:0] PV_CMPGT_SCI_H     = 32'b000101???????????110?????1010111;
  localparam [31:0] PV_CMPGTU_B        = 32'b0011010??????????001?????1010111;
  localparam [31:0] PV_CMPGTU_H        = 32'b0011010??????????000?????1010111;
  localparam [31:0] PV_CMPGTU_SC_B     = 32'b0011010??????????101?????1010111;
  localparam [31:0] PV_CMPGTU_SC_H     = 32'b0011010??????????100?????1010111;
  localparam [31:0] PV_CMPGTU_SCI_B    = 32'b001101???????????111?????1010111;
  localparam [31:0] PV_CMPGTU_SCI_H    = 32'b001101???????????110?????1010111;
  localparam [31:0] PV_CMPLE_B         = 32'b0010110??????????001?????1010111;
  localparam [31:0] PV_CMPLE_H         = 32'b0010110??????????000?????1010111;
  localparam [31:0] PV_CMPLE_SC_B      = 32'b0010110??????????101?????1010111;
  localparam [31:0] PV_CMPLE_SC_H      = 32'b0010110??????????100?????1010111;
  localparam [31:0] PV_CMPLE_SCI_B     = 32'b001011???????????111?????1010111;
  localparam [31:0] PV_CMPLE_SCI_H     = 32'b001011???????????110?????1010111;
  localparam [31:0] PV_CMPLEU_B        = 32'b0100110??????????001?????1010111;
  localparam [31:0] PV_CMPLEU_H        = 32'b0100110??????????000?????1010111;
  localparam [31:0] PV_CMPLEU_SC_B     = 32'b0100110??????????101?????1010111;
  localparam [31:0] PV_CMPLEU_SC_H     = 32'b0100110??????????100?????1010111;
  localparam [31:0] PV_CMPLEU_SCI_B    = 32'b010011???????????111?????1010111;
  localparam [31:0] PV_CMPLEU_SCI_H    = 32'b010011???????????110?????1010111;
  localparam [31:0] PV_CMPLT_B         = 32'b0010010??????????001?????1010111;
  localparam [31:0] PV_CMPLT_H         = 32'b0010010??????????000?????1010111;
  localparam [31:0] PV_CMPLT_SC_B      = 32'b0010010??????????101?????1010111;
  localparam [31:0] PV_CMPLT_SC_H      = 32'b0010010??????????100?????1010111;
  localparam [31:0] PV_CMPLT_SCI_B     = 32'b001001???????????111?????1010111;
  localparam [31:0] PV_CMPLT_SCI_H     = 32'b001001???????????110?????1010111;
  localparam [31:0] PV_CMPLTU_B        = 32'b0100010??????????001?????1010111;
  localparam [31:0] PV_CMPLTU_H        = 32'b0100010??????????000?????1010111;
  localparam [31:0] PV_CMPLTU_SC_B     = 32'b0100010??????????101?????1010111;
  localparam [31:0] PV_CMPLTU_SC_H     = 32'b0100010??????????100?????1010111;
  localparam [31:0] PV_CMPLTU_SCI_B    = 32'b010001???????????111?????1010111;
  localparam [31:0] PV_CMPLTU_SCI_H    = 32'b010001???????????110?????1010111;
  localparam [31:0] PV_CMPNE_B         = 32'b0000110??????????001?????1010111;
  localparam [31:0] PV_CMPNE_H         = 32'b0000110??????????000?????1010111;
  localparam [31:0] PV_CMPNE_SC_B      = 32'b0000110??????????101?????1010111;
  localparam [31:0] PV_CMPNE_SC_H      = 32'b0000110??????????100?????1010111;
  localparam [31:0] PV_CMPNE_SCI_B     = 32'b000011???????????111?????1010111;
  localparam [31:0] PV_CMPNE_SCI_H     = 32'b000011???????????110?????1010111;
  ...
  localparam [31:0] PV_PACK            = 32'b1101000??????????000?????1010111;
  localparam [31:0] PV_PACK_H          = 32'b1101001??????????000?????1010111;
  localparam [31:0] PV_PACKHI_B        = 32'b1101100??????????001?????1010111;
  localparam [31:0] PV_PACKLO_B        = 32'b1110000??????????001?????1010111;
  ...
  localparam [31:0] PV_SHUFFLE_B       = 32'b1100000??????????001?????1010111;
  localparam [31:0] PV_SHUFFLE_H       = 32'b1100000??????????000?????1010111;
  localparam [31:0] PV_SHUFFLE_SCI_H   = 32'b110000???????????110?????1010111;
  localparam [31:0] PV_SHUFFLEI0_SCI_B = 32'b110000???????????111?????1010111;
  localparam [31:0] PV_SHUFFLEI1_SCI_B = 32'b111010???????????111?????1010111;
  localparam [31:0] PV_SHUFFLEI2_SCI_B = 32'b111100???????????111?????1010111;
  localparam [31:0] PV_SHUFFLEI3_SCI_B = 32'b111110???????????111?????1010111;
  ...
  localparam [31:0] PV_SUB_H_DIV2      = 32'b0110010??????????010?????1010111;
  localparam [31:0] PV_SUB_H_DIV4      = 32'b0110010??????????100?????1010111;
  localparam [31:0] PV_SUB_H_DIV8      = 32'b0110010??????????110?????1010111;
  ...
  localparam [31:0] SCFGR              = 32'b0000000?????00001001?????0101011;
  localparam [31:0] SCFGRI             = 32'b????????????00000001?????0101011;
  localparam [31:0] SCFGW              = 32'b0000000??????????010000010101011;
  localparam [31:0] SCFGWI             = 32'b?????????????????010000000101011;
  ...
  localparam [31:0] SHFLI              = 32'b0000100??????????001?????0010011;
  ...
  localparam [31:0] UNSHFLI            = 32'b0000100??????????101?????0010011;
  ...
  localparam [31:0] VFCVT_B_B          = 32'b100110000111?????011?????0110011;
  ...
  localparam [31:0] VFCVT_D_S          = 32'b100110000100?????001?????0110011;
  ...
  localparam [31:0] VFCVTU_B_B         = 32'b100110000111?????111?????0110011;
  localparam [31:0] VFCVTU_B_H         = 32'b100110000110?????111?????0110011;
  localparam [31:0] VFCVTU_B_S         = 32'b100110000100?????111?????0110011;
  localparam [31:0] VFCVTU_D_S         = 32'b100110000100?????101?????0110011;
  localparam [31:0] VFCVTU_H_B         = 32'b100110000111?????110?????0110011;
  localparam [31:0] VFCVTU_H_H         = 32'b100110000101?????110?????0110011;
  ...
  localparam [31:0] VFDOTPEX_H_B       = 32'b1001011??????????010?????0110011;
  localparam [31:0] VFDOTPEX_H_R_B     = 32'b1001011??????????110?????0110011;
  localparam [31:0] VFDOTPEX_S_H       = 32'b1001011??????????000?????0110011;
  localparam [31:0] VFDOTPEX_S_R_H     = 32'b1001011??????????100?????0110011;
  ...
  localparam [31:0] VFNDOTPEX_H_R_B    = 32'b1011101??????????110?????0110011;
  localparam [31:0] VFNDOTPEX_S_H      = 32'b1011101??????????000?????0110011;
  localparam [31:0] VFNDOTPEX_S_R_H    = 32'b1011101??????????100?????0110011;
  ...
  localparam [31:0] VFNSUM_B           = 32'b101011100111?????011?????0110011;
  localparam [31:0] VFNSUM_H           = 32'b101011111110?????010?????0110011;
  localparam [31:0] VFNSUM_S           = 32'b101011111100?????000?????0110011;
  localparam [31:0] VFNSUMEX_H_B       = 32'b101011110111?????010?????0110011;
  localparam [31:0] VFNSUMEX_S_H       = 32'b101011110110?????000?????0110011;
  ...
  localparam [31:0] VFSUM_B            = 32'b100011100111?????011?????0110011;
  localparam [31:0] VFSUM_H            = 32'b100011111110?????010?????0110011;
  localparam [31:0] VFSUM_S            = 32'b100011111100?????000?????0110011;
  localparam [31:0] VFSUMEX_H_B        = 32'b100011110111?????010?????0110011;
  localparam [31:0] VFSUMEX_S_H        = 32'b100011110110?????000?????0110011;
  ...
  localparam logic [11:0] CSR_VTLREG = 12'h7c8;
  localparam logic [11:0] CSR_VTLIDXW = 12'h7c9;
  localparam logic [11:0] CSR_VTLBLKS = 12'h7ca;
  localparam logic [11:0] CSR_VTLRATIO = 12'h7cb;
